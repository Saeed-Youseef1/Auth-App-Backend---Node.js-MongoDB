...
const register = async (req,res)=> {
    ...
    res.status(201).json({accessToken,email:user.email,first_name:user.first_name,last_name:user.last_name})
}
...
const login = async (req,res)=> {
    ...
    res.status(201).json({accessToken,email:foundUser.email})
}
